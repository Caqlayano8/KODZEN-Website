param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\cleaner")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Cleaner"
...
$shortcutPath = Join-Path $desktop 'cleaner-Full.url'
