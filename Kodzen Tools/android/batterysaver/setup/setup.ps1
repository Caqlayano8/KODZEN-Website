param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\batterysaver")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen BatterySaver"
...
$shortcutPath = Join-Path $desktop 'batterysaver-Full.url'
