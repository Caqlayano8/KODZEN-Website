param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\attendance")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Attendance"
...
$shortcutPath = Join-Path $desktop 'attendance-Full.url'
