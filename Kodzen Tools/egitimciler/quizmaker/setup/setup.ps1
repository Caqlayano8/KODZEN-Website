param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\quizmaker")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen QuizMaker"
...
$shortcutPath = Join-Path $desktop 'quizmaker-Full.url'
