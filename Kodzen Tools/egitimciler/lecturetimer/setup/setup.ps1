param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\lecturetimer")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen LectureTimer"
...
$shortcutPath = Join-Path $desktop 'lecturetimer-Full.url'
