param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\gradebook")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen GradeBook"
...
$shortcutPath = Join-Path $desktop 'gradebook-Full.url'
