param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\classplanner")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen ClassPlanner"
...
$shortcutPath = Join-Path $desktop 'classplanner-Full.url'
