param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\secureaudit")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen SecureAudit"
...
$shortcutPath = Join-Path $desktop 'secureaudit-Full.url'
