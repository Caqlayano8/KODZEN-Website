param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\phishalert")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen PhishAlert"
...
$shortcutPath = Join-Path $desktop 'phishalert-Full.url'
