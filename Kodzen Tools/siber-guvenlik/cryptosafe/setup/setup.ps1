param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\cryptosafe")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen CryptoSafe"
...
$shortcutPath = Join-Path $desktop 'cryptosafe-Full.url'
