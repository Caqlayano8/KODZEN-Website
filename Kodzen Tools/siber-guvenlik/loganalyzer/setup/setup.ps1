param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\loganalyzer")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen LogAnalyzer"
...
$shortcutPath = Join-Path $desktop 'loganalyzer-Full.url'
