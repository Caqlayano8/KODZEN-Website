param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\timetracker")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen TimeTracker"
...
$shortcutPath = Join-Path $desktop 'timetracker-Full.url'
