param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\collaboration")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Collaboration"
...
$shortcutPath = Join-Path $desktop 'collaboration-Full.url'
