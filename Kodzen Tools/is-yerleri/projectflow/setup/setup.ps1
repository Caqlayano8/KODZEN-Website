param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\projectflow")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen ProjectFlow"
...
$shortcutPath = Join-Path $desktop 'projectflow-Full.url'
