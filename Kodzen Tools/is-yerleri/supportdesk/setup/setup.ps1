param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\supportdesk")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen SupportDesk"
...
$shortcutPath = Join-Path $desktop 'supportdesk-Full.url'
