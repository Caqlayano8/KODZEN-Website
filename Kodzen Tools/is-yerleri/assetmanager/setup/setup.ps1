param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\assetmanager")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen AssetManager"
...
$shortcutPath = Join-Path $desktop 'assetmanager-Full.url'
