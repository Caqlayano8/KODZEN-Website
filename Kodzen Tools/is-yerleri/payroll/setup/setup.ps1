param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\payroll")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Payroll"
...
$shortcutPath = Join-Path $desktop 'payroll-Full.url'
