param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\invoicepro")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen InvoicePro"
...
$shortcutPath = Join-Path $desktop 'invoicepro-Full.url'
