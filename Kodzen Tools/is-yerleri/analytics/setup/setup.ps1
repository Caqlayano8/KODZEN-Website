param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\analytics")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Analytics"
...
$shortcutPath = Join-Path $desktop 'analytics-Full.url'
