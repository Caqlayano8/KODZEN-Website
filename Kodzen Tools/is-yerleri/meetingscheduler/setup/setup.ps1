param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\meetingscheduler")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen MeetingScheduler"
...
$shortcutPath = Join-Path $desktop 'meetingscheduler-Full.url'
