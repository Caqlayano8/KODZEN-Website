param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\visitorlog")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen VisitorLog"
...
$shortcutPath = Join-Path $desktop 'visitorlog-Full.url'
