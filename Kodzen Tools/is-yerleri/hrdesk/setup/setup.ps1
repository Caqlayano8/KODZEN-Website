param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\hrdesk")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen HRDesk"
...
$shortcutPath = Join-Path $desktop 'hrdesk-Full.url'
