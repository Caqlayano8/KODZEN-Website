param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\prototype-9")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Prototype 9"
...
$shortcutPath = Join-Path $desktop 'prototype-9-Full.url'
