param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\prototype-4")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Prototype 4"
...
$shortcutPath = Join-Path $desktop 'prototype-4-Full.url'
