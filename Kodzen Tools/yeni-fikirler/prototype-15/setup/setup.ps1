param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\prototype-15")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Prototype 15"
...
$shortcutPath = Join-Path $desktop 'prototype-15-Full.url'
