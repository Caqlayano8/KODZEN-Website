...
(function(){
  const APP_ID = "prototype-10";
  const APP_NAME = "Kodzen Prototype 10";
  const APP_GROUP = "yeni-fikirler";
  const APP_SUMMARY = "Erken asama urun fikri, hizli PoC ve geri bildirim odakli.";
