param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\prototype-5")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Prototype 5"
...
$shortcutPath = Join-Path $desktop 'prototype-5-Full.url'
