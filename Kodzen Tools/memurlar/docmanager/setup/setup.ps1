param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\docmanager")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen DocManager"
...
$shortcutPath = Join-Path $desktop 'docmanager-Full.url'
