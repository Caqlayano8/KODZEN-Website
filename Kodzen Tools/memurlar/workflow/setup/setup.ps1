param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\workflow")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Workflow"
...
$shortcutPath = Join-Path $desktop 'workflow-Full.url'
