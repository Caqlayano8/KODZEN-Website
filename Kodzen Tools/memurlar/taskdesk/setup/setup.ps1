param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\taskdesk")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen TaskDesk"
...
$shortcutPath = Join-Path $desktop 'taskdesk-Full.url'
