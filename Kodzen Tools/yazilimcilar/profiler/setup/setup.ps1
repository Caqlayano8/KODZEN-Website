param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\profiler")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen Performance Profiler"
...
$shortcutPath = Join-Path $desktop 'profiler-Full.url'
