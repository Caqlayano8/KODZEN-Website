param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\devtracker")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen DevTracker"
...
$shortcutPath = Join-Path $desktop 'devtracker-Full.url'
