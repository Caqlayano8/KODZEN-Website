param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\apimockserver")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen API MockServer"
...
$shortcutPath = Join-Path $desktop 'apimockserver-Full.url'
