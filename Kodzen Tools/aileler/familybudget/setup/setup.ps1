param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\familybudget")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen FamilyBudget"
...
$shortcutPath = Join-Path $desktop 'familybudget-Full.url'
