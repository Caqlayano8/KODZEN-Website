param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\mealplanner")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen MealPlanner"
...
$shortcutPath = Join-Path $desktop 'mealplanner-Full.url'
