param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\kidstracker")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen KidsTracker"
...
$shortcutPath = Join-Path $desktop 'kidstracker-Full.url'
