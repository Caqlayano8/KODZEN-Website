param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\familycalendar")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen FamilyCalendar"
...
$shortcutPath = Join-Path $desktop 'familycalendar-Full.url'
