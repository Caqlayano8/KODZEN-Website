param(
  [string]$InstallPath = (Join-Path $env:LOCALAPPDATA "Kodzen\choremanager")
)

$ErrorActionPreference = 'Stop'
$source = Split-Path -Parent $PSScriptRoot

Write-Host "[Kodzen] Full kurulum basladi: Kodzen ChoreManager"
...
$shortcutPath = Join-Path $desktop 'choremanager-Full.url'
